(function (global, factory) {
	...
	var func = convert_1('curry', curry_1);

	func.placeholder = placeholder;
	var curry$1 = func;

	var func$1 = convert_1('curryN', curry_1);
	...
	var func$2 = convert_1('attempt', attempt_1);
	...
	var func$3 = convert_1('isError', isError_1, _falseOptions);

	func$3.placeholder = placeholder;

	var func$4 = convert_1('isFunction', isFunction_1, _falseOptions);

	func$4.placeholder = placeholder;
	var isFunction$1 = func$4;

	var func$5 = convert_1('isArray', isArray_1, _falseOptions);

	func$5.placeholder = placeholder;
	var isArray$1 = func$5;
	...
	var func$6 = convert_1('once', once_1, _falseOptions);
	...
	var func$7 = convert_1('set', set_1);
	...
	var func$8 = convert_1('reduce', reduce_1);

	func$8.placeholder = placeholder;
	var reduce$1 = func$8;

	var func$9 = convert_1('memoize', memoize_1);

	func$9.placeholder = placeholder;
	var memoize$1 = func$9;
	...
	var func$a = convert_1('mapValues', mapValues_1);

	func$a.placeholder = placeholder;
	var mapValues$1 = func$a;

	function isThenable(f) {
	  return f && isFunction$1(f.then);
	...
	var before$1 = curryN(2, function (trackFn, fn) {
	  return function () {
	    ...
	    try {
	      isFunction$1(trackFn) && trackFn.apply(this, args);
	    } catch (e) {
	      console.error(e);
	    }
	...
	var after = curryN(2, function (trackFn, fn) {
	  return function () {
	...
	var track = function track(partical) {
	  return function (target, key, descriptor) {
	    ...
	    if (descriptor.initializer) {
	      return set$1('initializer', function () {
	    ...
	    return set$1('value', value, descriptor);
	  };
	}; // composeWith convergeFn by ops[array]

	var composeWith = curry$1(function (convergeFn, ops) {
	  if (isFunction$1(ops)) {
	    ops = [ops];
	  } // type check


	  if (!isFunction$1(convergeFn) || !isArray$1(ops)) {
	    return console.error('args type incorrect, expect convergeFn is function and ops is array');
	  }

	  var compose = reduce$1(function (acc, i) {
	    if (!acc) {
	      return acc || i;
	    }
	  ...
	  return curryN(1, function (fn, target) {
	    return function () {
	      var memoizeFn = memoize$1(fn);
	...
	var evolve = curry$1(function (evols) {
	  return function (fn) {
	    return function () {
	      ...
	      var self = this;
	      var memoizeFn = memoize$1(fn);
	      return mapValues$1(function (value) {
	        return value(memoizeFn).apply(self, args);
	      }, evols);
	    };
	  };
	});
	var identity$1 = curry$1(function (fn) {
	  return function () {
	...
	var decoratorTools$1 = /*#__PURE__*/Object.freeze({
		before: before$1,
		after: after,
		track: track,
		composeWith: composeWith,
	...
	var SERVER_URL = "http://api.yfyld.online:3030/project/mock/3/traker.gif";
	...
	function http(data) {
	  ...
	  return new Promise(function (resolve, reject) {
	    ...
	    if (isSendBeacon && window.navigator.sendBeacon) {
	      ...
	      var success = window.navigator.sendBeacon(SERVER_URL, formData);
	...
	function sendCookieData() {
	  var oldData = getCookie(TRACKER_DATA_KEY);

	  if (oldData && oldData !== '[]') {
	    _sendToServer(oldData, true).then(function () {
	      setCookie(TRACKER_DATA_KEY, "[]");
	    });
	  }
	}
	function sendStorageData() {
	  var oldData = localStorage.getItem(TRACKER_DATA_KEY);

	  if (oldData && oldData !== '[]') {
	    _sendToServer(oldData).then(function () {
	...
	function () {
	  function PageTracker() {
	    ...
	    _defineProperty$1(this, "url", location.origin);
	  }

	  _createClass(PageTracker, [{
	    key: "tracker",
	    value: function tracker() {
	      var pageId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
	      var data = {
	        url: this.url,
	        pageId: pageId
	      };
	...
	var PageTracker$1 = new PageTracker();

	var PageTimeTracker =
	/*#__PURE__*/
	function () {
	  function PageTimeTracker() {
	    _classCallCheck(this, PageTimeTracker);

	    _defineProperty$1(this, "startTime", Date.now());

	    _defineProperty$1(this, "endTime", Date.now());

	    _defineProperty$1(this, "pageTimes", []);

	    _defineProperty$1(this, "invalidStartTime", Date.now());

	    _defineProperty$1(this, "invalidEndTime", Date.now());

	    _defineProperty$1(this, "totalInvalidTime", 0);
	...
	var instance = new PageTimeTracker();

	function hijackHistoryEvent () {
	  if (getFlag('historyInjected')) return false;

	  function historyEventTrigger(event, data) {
	    var fetchEvent = new CustomEvent(event, {
	      detail: data
	    });
	...
	exports.default = src;
	exports.decoratorTools = decoratorTools$1;
	exports.PageTimeTracker = instance;
	exports.PageTracker = PageTracker$1;
